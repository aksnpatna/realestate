...
PRIORITY_PATTERNS = {
    ...
    "parks":         [r"park", r"green", r"greenspace", r"forest", r"bush", r"nature reserve", r"national park"],
    "amenities":     [r"amenity", r"cafe", r"restaurant", r"café", r"dining", r"food", r"shopping", r"retail", r"mall", r"shop"],
