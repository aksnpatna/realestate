...
export type IconName =
  | 'search' | 'home' | 'map' | 'chart' | 'brief' | 'wallet'
...
const paths: Record<IconName, string> = {
  ...
  map: 'M1 6v16l7-4 8 4 7-4V2l-7 4-8-4L1 6zM8 2v16M16 6v16',
  chart: 'M18 20V10M12 20V4M6 20v-6',
  brief: 'M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8zM14 2v6h6M16 13H8M16 17H8M10 9H8',
  wallet: 'M21 12V7H5a2 2 0 0 1 0-4h14v4M3 5v14a2 2 0 0 0 2 2h16v-9a2 2 0 0 0-2-2h-1M3 5h10M3 5v14',
...
export const Icon: React.FC<IconProps> = ({ name, size = 20, className = '', label }) => {
